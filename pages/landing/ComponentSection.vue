                ...
                <div class="box p-4">
                    <ul class="list-none p-0 m-0">
                        <li class="flex align-items-center mb-3">
                            <img src="/images/landing/avatar-1.svg" alt="avatar 1" class="w-2rem h-2rem mr-3" />
                        ...
                        <li class="flex align-items-center mb-3">
                            <img src="/images/landing/avatar-2.svg" alt="avatar 2" class="w-2rem h-2rem mr-3" />
                        ...
                        <li class="flex align-items-center mb-3">
                            <img src="/images/landing/avatar-3.svg" alt="avatar 3" class="w-2rem h-2rem mr-3" />
                            <span class="font-medium">Kathryn Murphy</span>
                            <ProgressBar :value="pbValue3" :showValue="false" class="w-10rem ml-auto mr-3" style="height: 0.5rem" />
                            <span class="text-secondary font-medium">50%</span>
                        </li>
                        <li class="flex align-items-center mb-3">
                            <img src="/images/landing/avatar-4.svg" alt="avatar 4" class="w-2rem h-2rem mr-3" />
                        ...
                        <li class="flex align-items-center mb-3">
                            <img src="/images/landing/avatar-5.svg" alt="avatar 5" class="w-2rem h-2rem mr-3" />
            ...
            <div class="flex flex-column justify-content-start px-3 z-1">
                <div class="box p-4 mb-5">
                    <div class="surface-card mb-4 w-20rem text-center p-5" style="border-radius: '10px'">
                        <img src="/images/landing/watch.png" alt="Watch" />
                    </div>
            ...
            <div class="flex flex-column px-3 py-5 z-1">
                ...
                <div class="box p-4 mb-5">
                    <ul class="list-none p-0 m-0">
                        <li class="flex mb-3">
                            <span class="mr-3">
                                <img src="/images/landing/avatar.png" alt="Avatar" class="w-3rem h-3rem" />
                            </span>
                            <div class="flex flex-column">
