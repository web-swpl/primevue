...
var script = {
    ...
    methods: {
        getSlotProp(name, props = {}, data = {}) {
            return utils.ObjectUtils.isNotEmpty(this.slotProps) ? { ...(utils.ObjectUtils.getItemValue(this.slotProps[name], { ...data, ...this.getRootData(name) }) || {}), ...props } : props;
        },
        getRootData(name) {
            const data = {
                states: {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
    ...
    vue.createElementVNode("div", vue.mergeProps({ class: "p-dropdown-trigger" }, $options.getSlotProp('trigger')), [
              ...
              ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
                  ...
                  ($props.filter)
                    ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
                        ...
                        vue.createElementVNode("div", vue.mergeProps({ class: "p-dropdown-filter-container" }, $options.getSlotProp('panelFilterContainer')), [
                        ...
                        vue.createElementVNode("span", _hoisted_5, vue.toDisplayString($options.filterResultMessageText), 1)
                      ], 16))
                    : vue.createCommentVNode("", true),
                  ...
                  (!$props.options || ($props.options && $props.options.length === 0))
                    ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_9, vue.toDisplayString($options.emptyMessageText), 1))
                    : vue.createCommentVNode("", true),
                  vue.createElementVNode("span", _hoisted_10, vue.toDisplayString($options.selectedMessageText), 1),
                  vue.createElementVNode("span", {
