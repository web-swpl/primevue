...
import { resolveComponent, resolveDirective, openBlock, createElementBlock, mergeProps, renderSlot, createTextVNode, toDisplayString, createCommentVNode, createElementVNode, createVNode, withCtx, Transition, createSlots, Fragment, renderList, withDirectives } from 'vue';
  ...
  return (openBlock(), createElementBlock("div", mergeProps({
    ...
    ($props.editable)
      ? (openBlock(), createElementBlock("input", mergeProps({
        ...
        }, $options.getSlotProp('input', $props.inputProps)), null, 16, _hoisted_2))
      : (openBlock(), createElementBlock("span", mergeProps({
        ...
        }, $options.getSlotProp('input', $props.inputProps)), [
    ...
    ($props.showClear && $props.modelValue != null)
      ? (openBlock(), createElementBlock("i", mergeProps({
        ...
        }, $options.getSlotProp('clearIcon', $props.clearIconProps)), null, 16))
      : createCommentVNode("", true),
    createElementVNode("div", mergeProps({ class: "p-dropdown-trigger" }, $options.getSlotProp('trigger')), [
      renderSlot(_ctx.$slots, "indicator", {}, () => [
        createElementVNode("span", mergeProps({
          class: $options.dropdownIconClass,
          "aria-hidden": "true"
        }, $options.getSlotProp('triggerIcon')), null, 16)
      ])
    ], 16),
          ...
          default: withCtx(() => [
            ($data.overlayVisible)
              ? (openBlock(), createElementBlock("div", mergeProps({
                ...
                }, $options.getSlotProp('panel', $props.panelProps)), [
                  ...
                  ($props.filter)
                    ? (openBlock(), createElementBlock("div", mergeProps({
                      ...
                      }, $options.getSlotProp('panelHeader')), [
                        createElementVNode("div", mergeProps({ class: "p-dropdown-filter-container" }, $options.getSlotProp('panelFilterContainer')), [
                          ...
                          }, $options.getSlotProp('panelFilterInput', $props.filterInputProps)), null, 16, _hoisted_4),
                          createElementVNode("span", mergeProps({
                            class: ['p-dropdown-filter-icon', $props.filterIcon]
                          }, $options.getSlotProp('panelFilterIcon')), null, 16)
                        ], 16),
                        createElementVNode("span", _hoisted_5, toDisplayString($options.filterResultMessageText), 1)
                      ], 16))
                    : createCommentVNode("", true),
                  createElementVNode("div", mergeProps({
                    class: "p-dropdown-items-wrapper",
                    style: { 'max-height': $options.virtualScrollerDisabled ? $props.scrollHeight : '' }
                  }, $options.getSlotProp('panelItemsWrapper')), [
                    createVNode(_component_VirtualScroller, mergeProps({ ref: $options.virtualScrollerRef }, $props.virtualScrollerOptions, {
                      ...
                      content: withCtx(({ styleClass, contentRef, items, getItemOptions, contentStyle, itemSize }) => [
                        createElementVNode("ul", mergeProps({
                          ...
                          style: contentStyle,
                          role: "listbox"
                        }, $options.getSlotProp('panelItems')), [
                            ...
                            return (openBlock(), createElementBlock(Fragment, {
                              ...
                              ($options.isOptionGroup(option))
                                ? (openBlock(), createElementBlock("li", mergeProps({
                                    ...
                                    role: "option"
                                  }, $options.getSlotProp('panelItemGroup', undefined, { option, index: $options.getOptionIndex(i, getItemOptions) })), [
                                ...
                                : withDirectives((openBlock(), createElementBlock("li", mergeProps({
                                    ...
                                    onMousemove: $event => ($options.onOptionMouseMove($event, $options.getOptionIndex(i, getItemOptions)))
                                                ...
                                                $options.getSlotProp('panelItem', undefined, {
                                                    option,
                                                    index: $options.getOptionIndex(i, getItemOptions),
                                                    states: { selected: $options.isSelected(option), focused: $data.focusedOptionIndex === $options.getOptionIndex(i, getItemOptions), disabled: $options.isOptionDisabled(option) }
                                                })
                                            ), [
                          ...
                          ($data.filterValue && (!items || (items && items.length === 0)))
                            ? (openBlock(), createElementBlock("li", mergeProps({
                                ...
                                role: "option"
                              }, $options.getSlotProp('panelEmptyFilter')), [
                            ...
                            : (!$props.options || ($props.options && $props.options.length === 0))
                              ? (openBlock(), createElementBlock("li", mergeProps({
                                  ...
                                  class: "p-dropdown-empty-message",
                                  role: "option"
                                }, $options.getSlotProp('panelEmpty')), [
                  ...
                  (!$props.options || ($props.options && $props.options.length === 0))
                    ? (openBlock(), createElementBlock("span", _hoisted_9, toDisplayString($options.emptyMessageText), 1))
                    : createCommentVNode("", true),
                  createElementVNode("span", _hoisted_10, toDisplayString($options.selectedMessageText), 1),
                  createElementVNode("span", {
