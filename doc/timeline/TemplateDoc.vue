        ...
        <Timeline :value="events" align="alternate" class="customized-timeline">
            ...
            <template #content="slotProps">
                <Card>
                    ...
                    <template #content>
                        <img v-if="slotProps.item.image" :src="`https://primefaces.org/cdn/primereact/images/product/${slotProps.item.image}`" :alt="slotProps.item.name" width="200" class="shadow-1" />
                        <p>
